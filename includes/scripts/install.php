<?php
// Check if the constant __FILE__ is defined (prevents direct access)
if (!defined('__FILE__')) {
...
(239, 'ZW', 'ZIMBABWE', 'Zimbabwe', 'ZWE', 716, 263);"; // Your SQL query here
...
foreach ($matches[1] as $match) {
    ...
    $iso3 = trim($values[4], "' ");
    $numcode = trim($values[5]);
    $phonecode = trim($values[6]);
